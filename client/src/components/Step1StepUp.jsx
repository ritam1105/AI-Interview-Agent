      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        transition'
            ...
            <div className='relative'>
              ...
              <input type='text' placeholder='Enter experience(e.g. 3 years)'
                className='w-full pl-12 pr-4 py-3 border border-gray-200
        rounded-xl focus:ring-2 focus:ring-green-500 outline-none
        transition'
    ...
    hover:border-green-500 hover:bg-green-50 transition'>
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    className='mt-4 bg-green-900 text-white py-2 px-5 rounded-xl
                  hover:bg-grey-800 transition'>
        ...
        space-y-4'>
                  ...
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {skills.map((skill, idx) => (
                        <span key={idx} className='bg-green-100 text-green-800 py-1 px-3 rounded-full text-sm'>
                          {skill}
                        </span>
                      ))}
                    </div>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.95 }}
              className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-
    text-white py-3 rounded-full text-lg font-semibold transition
