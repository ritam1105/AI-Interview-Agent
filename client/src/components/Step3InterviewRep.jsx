...
function Step3InterviewRep({ report }) {
  if (!report) {
    return (
      <div className='flex items-center justify-center h-full'>
        <p className='text-gray-500 text-lg'>No report available</p>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
        ...
        <div className='md:mb-10 w-full flex items-start gap-4 flex-wrap'>
          ...
          <div>
            <h1 className='text-3xl font-bold flex-nowrap text-gray-800'>
              Interview Analitic Dashboard
            </h1>

            <p className='text-gray-500 mt-2'>
              AI powered insights to boost your interview performance
            </p>
          </div>
        </div>
        <button
        onClick={downloadPDF} 
        className="bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-5 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap">
          Download PDF
        </button>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="space-y-6">
          ...
          >
            <h3 className="mb-4 sm:mb-6 text-sm sm:text-base text-gray-800">Overall Performance</h3>
            <div className='realtive w-20 h-20 mx-auto sm:w-25 sm:h-25'>
              <CircularProgressbar
                value={percentage}
                text={`${score}/10`}
                styles={buildStyles({
...
export default Step3InterviewRep