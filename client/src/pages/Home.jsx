...
import techImg from "../assets/technical.png";
import confidenceImg from "../assets/confidence.png";
import creditImg from "../assets/credit.png";
import evalImg from "../assets/Ai-human.png";
import resumeImg from "../assets/resume.png";
import pdfImg from "../assets/cv.png";
import analyticsImg from "../assets/startUp.png";
          ...
          <div className="text-center mb-28">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className="bg-white border border-gray-300 text-black px-10 py-3 rounded-full hover:opacity-90 transition shadow-md"
              >
                View History
              </motion.button>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  className="bg-white border border-gray-200 rounded-3xl shadow-sm hover:shadow-xl transition-all p-6 h-full"
                >
          ...
          <div className="mb-32">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-all p-4 h-full"
                >
